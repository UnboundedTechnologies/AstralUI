...
const files = ['src/styles/tokens.css', 'src/styles/utilities.css', 'src/styles/toast.css', 'src/styles/backgrounds.css', 'src/styles/charts.css', 'src/styles/auth.css', 'src/styles/badge.css', 'src/styles/search.css'];
